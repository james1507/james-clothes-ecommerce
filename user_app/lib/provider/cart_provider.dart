...
import 'package:james_clothes_app/data/model/body/selected_shipping_type.dart';
import 'package:james_clothes_app/data/model/response/base/api_response.dart';
import 'package:james_clothes_app/data/model/response/base/error_response.dart';
import 'package:james_clothes_app/data/model/response/cart_model.dart';
import 'package:james_clothes_app/data/model/response/chosen_shipping_method.dart';
import 'package:james_clothes_app/data/model/response/product_model.dart';
import 'package:james_clothes_app/data/model/response/response_model.dart';
import 'package:james_clothes_app/data/model/response/shipping_method_model.dart';
import 'package:james_clothes_app/data/model/response/shipping_model.dart';
import 'package:james_clothes_app/data/repository/cart_repo.dart';
import 'package:james_clothes_app/helper/api_checker.dart';
