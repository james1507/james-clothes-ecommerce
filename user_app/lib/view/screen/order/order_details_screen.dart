...
import 'package:james_clothes_app/helper/date_converter.dart';
import 'package:james_clothes_app/provider/localization_provider.dart';
import 'package:james_clothes_app/view/basewidget/shimmer_loading.dart';
import 'package:james_clothes_app/view/screen/dashboard/dashboard_screen.dart';
import 'package:james_clothes_app/view/screen/order/widget/cal_chat_widget.dart';
import 'package:james_clothes_app/view/screen/order/widget/cancel_and_support_center.dart';
import 'package:james_clothes_app/view/screen/order/widget/ordered_product_list.dart';
import 'package:james_clothes_app/view/screen/order/widget/payment_info.dart';
import 'package:james_clothes_app/view/screen/order/widget/seller_section.dart';
import 'package:james_clothes_app/view/screen/order/widget/shipping_info.dart';
import 'package:james_clothes_app/data/model/response/order_model.dart';
                                              ...
                                              order.onlyDigital
                                                  ? Expanded(
                                                      ...
                                                      padding: const EdgeInsets
                                                          ...
                                                          vertical: 1),
                                                      child: Text(
                                                          ' ${widget.orderModel != null && widget.orderModel.shippingAddressData != null ? widget.orderModel.shippingAddressData.address : ''}',
                                                          maxLines: 3,
                                            ...
                                            Expanded(
                                              ...
                                              padding:
                                                  const EdgeInsets.symmetric(
                                                      vertical: 1),
                                              child: Text(
                                                  ' ${widget.orderModel.billingAddressData != null ? widget.orderModel.billingAddressData.address : ''}',
                                                  maxLines: 3,
                                                  overflow:
