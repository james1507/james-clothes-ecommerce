...
<div class="product-single-hover" >
    ...
    <div class="text-center quick-view">
        ...
        @else
            ...
            style="margin-top:0px;padding-top:5px;padding-bottom:5px;padding-left:10px;padding-right:10px;color:white;" href="javascript:"
               onclick="quickView('{{$product->id}}')">
                <i class="czi-eye align-middle {{Session::get('direction') === "rtl" ? 'ml-1' : 'mr-1'}}"></i>
                    {{\App\CPU\translate('View')}} {{\App\CPU\translate('Quick')}}
            </a>
        @endif
    </div>
</div>
