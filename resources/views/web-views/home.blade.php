    ...
    <div class="container rtl">
        <div class="row">
            ...
            <div class="col-xl-3 col-md-4 pb-4 mt-3 pl-0 pr-0">
                <div class="deal_of_the_day" style="background: {{$web_config['primary_color']}};height: 800px;">
                    @if(isset($deal_of_the_day) && isset($deal_of_the_day->product))
                        ...
                        <div class="recomanded-product-card">
                            ...
                            <div style="background:#ffffff;margin:20px;padding-top: 10px;height: 100px;border-radius: 0px 0px 5px 5px;">
                                <div style="text-align: left; padding: 20px;">

                                    @php($overallRating = \App\CPU\ProductManager::get_overall_rating($deal_of_the_day->product['reviews']))
                                    <div class="rating-show" style="height:125px; te">
                                        <h5 style="font-weight: 600px; color: {{$web_config['primary_color']}}">
                    ...
                    @else
                        ...
                        @if(isset($product))
                            ...
                            <div class="recomanded-product-card">
                                ...
                                <div style="background:#ffffff;margin:0px;padding-top: 10px;height: 200px;border-radius: 0px 0px 5px 5px;">
                                    <div style="text-align: left; padding: 20px;">

                                        @php($overallRating = \App\CPU\ProductManager::get_overall_rating($product['reviews']))
                                        <div class="rating-show" style="height:120px; text-align:center;">
                                            <h5 style="font-weight: 600px; color: {{$web_config['primary_color']}}">
                                        ...
                                        <div>
                                            @if($product->discount > 0)
                                                <strike style="font-size: 12px!important;color: #E96A6A!important; padding: 80px; margin: auto;">
                                                    {{\App\CPU\Helpers::currency_converter($product->unit_price)}}
                                                </strike>
                                            @endif
                                            <span class="text-accent" style="margin: 60px;">
                                                {{\App\CPU\Helpers::currency_converter(
                            ...
                            <div class="recomanded-buy-button">
                                <button class="buy_btn" style="color:{{$web_config['primary_color']}};margin:25px;"
